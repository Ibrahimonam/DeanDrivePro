...
<div class="container mt-5">
  ...
  <div class="row mb-4 align-items-center">
    <div class="col-12 col-md-6">
      <h3 class="text-light text-uppercase">Expired Students</h3>
    </div>
  ...
  <div class="row mb-4 align-items-center">
    <div class="col-12 col-md-6">
      <h5 class="text-light">
        Total Expired: <span class="text-light">{{ $students->total() }}</span>
      </h5>
    </div>
    ...
    <table class="table table-striped align-middle">
      ...
      <tbody>
        @forelse($students as $student)
          <tr>
            <td class="text-white">
              <a href="{{ route('students.expired.show', $student) }}" class="text-decoration-none text-light">
                {{ '0'.$student->id }}
              </a>
            </td>
            <td class="text-white">
        ...
        @empty
          <tr>
            <td colspan="11" class="text-center text-white">No Expired students found.</td>
          </tr>
        @endforelse
      </tbody>
    </table>
