...
<div class="container mt-5">
  ...
  <div class="text-center mb-4">
    <h3 class="blockquote text-light text-uppercase">{{ $student->full_name }} <small>(Alumni)</small></h3>
  </div>

  {{-- Back --}}
  <div class="mb-3">
    <a class="btn btn-outline-primary" href="{{ route('students.alumni') }}">
      <i class="mdi mdi-arrow-left"></i> Back to Alumni List
    </a>
  </div>
  ...
  @empty
    <div class="alert alert-light text-center">
      No invoices found for this alumni.
    </div>
  @endforelse
