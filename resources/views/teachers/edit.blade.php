    ...
    <div class="col-md-8">
      <div class="card bg-dark text-light shadow">
        <div class="card-header text-center">
          <h3 class="text-uppercase mb-0">Edit Teacher</h3>
        </div>
        <div class="card-body">
          <!-- Back Button -->
          <div class="mb-3">
              ...
              <div class="col-sm-9">
                <select name="branch_id" class="form-control bg-secondary text-light">
                  ...
                  @foreach($branches as $b)
                    <option value="{{ $b->id }}" {{ old('branch_id', $teacher->branch_id)==$b->id?'selected':'' }}>
                      {{ $b->name }}
                    </option>
                  @endforeach
                </select>
            ...
            <div class="form-group row mt-4">
              <div class="d-flex justify-content-end w-100">
                <button class="btn btn-outline-success">
                  <i class="mdi mdi-content-save"></i> Update Teacher
                </button>
              </div>
            </div>
          </form>
